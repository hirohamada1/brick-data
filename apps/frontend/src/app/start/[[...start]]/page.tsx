...
export default function Page() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Hier wird die SignIn/SignUp Komponente von Clerk gerendert. */}
      <main className="container mx-auto px-4 md:px-8 py-12">
        <div className="mx-auto max-w-md">
          <div className="rounded-3xl border border-border bg-card p-6 shadow-sm">
            <h1 className="text-2xl font-semibold">
              {isSignUpPage ? "Registrieren" : "Anmelden"}
            </h1>
            <p className="mt-1 text-sm text-muted-foreground">
              {isSignUpPage
                ? "Erstelle dein Konto, um dein Dashboard zu nutzen."
                : "Bitte logge dich ein, um dein Dashboard zu öffnen."}
            </p>

            {/* Hier wird die SignIn/SignUp Komponente von Clerk gestelllt und interpretiert. Die Email, Passwort und OAuth werden angenome. Request an Clerk wird gesendet. */}
            <div className="mt-6">
              {isSignUpPage ? (
                <SignUp
                  path="/start/sign-up"
